    ...
    <div class="page-header-content header-elements-md-inline">
        <div class="page-title d-flex">
            <h4><i class="far fa-newspaper mr-2"></i> <span
                    class="font-weight-semibold">{{ trans('post::post.name') }}</span> - {{ trans('post::post.list') }}
            </h4>
                ...
                <tbody>
                    @foreach ($posts as $post)
                        <tr>
                            ...
                            <td class="text-center">{!! $post['status'] ? '<span class="text-success"><i class="fa fa-check"></i></span>' : '<span class="text-danger"><i class="fa fa-close"></i></span>' !!}</td>
                            <td class="text-center"><span data-popup="tooltip"
                                    title="{{ $post['created_at'] }}">{{ cms_time_elapsed_string($post['created_at']) }}</span>
                            </td>
                            <td class="text-center">
                                {{-- <a href="{{ route('post.admin.edit', $post['id']) }}" class="text-warning mr-2"
                                    data-popup="tooltip" title="{{ trans('post::post.edit') }}"><i
                                        class="fa fa-edit"></i></a> --}}

                                <a href="{{ route('post.admin.edit', $post['id']) }}" class="btn btn-xs btn-warning"><i
                                        class="fa fa-edit"></i></a>

                                {{-- <a href="javascript:;" onclick="askToDelete(this);return false;"
                                    data-href="{{ route('post.admin.delete', $post['id']) }}" class="text-danger mr-2"
                                    data-popup="tooltip" title="{{ trans('post::post.delete') }}"><i
                                        class="fas fa-trash-alt"></i></a> --}}
                                <a href="javascript:;" onclick="askToDelete(this); return false;"
                                    data-href="{{ route('post.admin.delete', $post['id']) }}"
