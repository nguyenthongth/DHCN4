                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-9">
                            <input placeholder="{{ trans('post::post.title') }}" id="txtTitle" name="title"
                                ...
                                oninvalid="this.setCustomValidity('vui lòng nhập số tiêu đề ')"
                        ...
                        <div class="col-lg-9">
                            <div class="input-group">
                                <input placeholder="{{ trans('post::post.slug') }}" id="txtSlug" type="text"
                                    class="form-control" name="slug" value="{{ old('slug') }}" required
                                    oninvalid="this.setCustomValidity('vui lòng nhập liên kết tĩnh ')"
                                    oninput="setCustomValidity('')">
                                <div class="input-group-prepend mr-0">
                                    <a href="javascript:;" onclick="get_slug('#txtTitle', '#txtSlug');"
                                        class="btn btn-dark btn-sm"><em class="fa fa-refresh"></em></a>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-lg-9">
                            <div class="input-group areaBrowserFile">
                                <input placeholder="{{ trans('post::post.image') }}" readonly type="text" id="post-image"
                                    class="form-control" name="image" value="{{ old('image') }}" required
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-12">
                            <textarea id="content" name="content" required
                                                    oninvalid="this.setCustomValidity('vui lòng nhập nội dung ')"
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input name="author" type="text" class="form-control"
                            placeholder="{{ trans('post::post.author') }}" value="{{ old('author') }}" required
                                                    oninvalid="this.setCustomValidity('vui lòng nhập tác giả ')"
                                                    oninput="setCustomValidity('')">
                    </div>
                    <div class="form-group">
