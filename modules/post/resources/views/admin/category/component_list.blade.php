                                ...
                                <div class="form-check form-check-switchery form-check-switchery-sm">
                                    <label class="form-check-label">
                                        <input data-id="{{ $cat['id'] }}" type="checkbox"
                                            class="form-input-switchery" {{ $cat['status'] ? 'checked' : '' }}>
                                    </label>
                                </div>
                            </td>
                            <td class="text-center">
                                ...
                                <a href="javascript:;" onclick="askToDelete(this);return false;"
                                    data-href="{{ route('category.admin.delete', $cat['id']) }}"
                                    class="text-danger mr-2" data-popup="tooltip"
                                    title="{{ trans('post::category.delete') }}"><i class="fas fa-trash-alt"></i></a>
                            </td>
                        </tr>
                    @endforeach
                </tbody>
