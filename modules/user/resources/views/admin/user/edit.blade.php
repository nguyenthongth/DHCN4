    ...
    <div class="tab-pane fadeshow" id="tab-information">
        <div class="card-body">
            <div class="form-group row">
                ...
                {{-- <div class="col-lg-9">
                    ...
                    <select name="info[department_id]" class="form-control select2">
                        ...
                        <option value="{{ $iDepartment['id'] }}" {{ old('info.department_id', $user->info['department_id']) == $iDepartment['id'] ? 'selected' : '' }}>
                            {{ $iDepartment['name'] }}</option>
                        @endforeach
                    </select>
                </div> --}}
            </div>
            <div class="form-group row">
                ...
                <div class="col-lg-9">
                    <input autocomplete="new-password" type="text" class=" form-control" name="info[fullname]" value="{{ isset($user->info['fullname']) ? old('info.fullname', $user->info['fullname']) : '' }}" placeholder="Nhập họ tên">
                </div>
            </div>
            <div class="form-group row">
            ...
            <div class="col-12">
                <div class="form-group">
                    ...
                    <select name="roles[]" id="selectRole" multiple="multiple" class="form-control select2" onchange="autoCheckPermissions();">
                        ...
                        <option value="{{ $iRole['id'] }}" {{ in_array($iRole['id'], old('roles', $user['arr_roles'])) ? 'selected' : '' }}>
